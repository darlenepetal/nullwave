<svelte:head>
	<title>tess</title>
	<meta name="description" content="come home"/>
</svelte:head>
<div class="row border-head" style="padding:1rem;">
	<div>
		<div class="article">
			...
			<a class="nav-item nav-link variable-manrope article-link" href="https://www.tumblr.com/planetarytransformation" style="margin: 0.5rem;">
				my tumblr:<br><i>planetarytransformation</i>
			</a>
			<a class="nav-item nav-link variable-manrope article-link" href="/essays/rules-for-pornsick-dovahkiin" style="margin-top: 0.5rem;">
				my work:<br><i>RULES FOR PORNSICK DOVAHKIIN</i>
			</a>
		</div>
	</div>
</div>